###################################################################################
# Cascade Unit Test on MSS Makefile - DDMA variant
# Lives inside am273xDDMA/, replacing the copied mssTest.mak.
# $(CASCADE_APP_DIR)         = app folder (am273xDDMA)
# $(MMWAVE_SDK_DEVICE_TYPE)  = device (am273x) - libraries, platform paths
###################################################################################
.PHONY: mssTest mssTestClean

vpath %.c $(CASCADE_APP_DIR)
...
CASCADE_MSS_UNIT_TEST_MAP		 = $(CASCADE_APP_DIR)/$(CASCADE_APP_DIR)_cascade_mss.map
CASCADE_MSS_UNIT_TEST_OUT		 = $(CASCADE_APP_DIR)/$(CASCADE_APP_DIR)_cascade_mss.$($(MSS_CPU)_EXE_EXT)
CASCADE_MSS_UNIT_TEST_BIN		 = $(CASCADE_APP_DIR)/$(CASCADE_APP_DIR)_cascade_mss.bin
CASCADE_MSS_UNIT_TEST_APP_CMD	 = $(CASCADE_APP_DIR)/mss_linker.cmd
...
mssTest: buildDirectories mssbuildDirectories $(CASCADE_MSS_UNIT_TEST_OBJECTS) $(CASCADE_MSS_UNIT_TEST_OBJECTS_GEN)
	...
	@echo '******************************************************************************'
	@echo 'Built the mmWave Cascade MSS Unit Test (DDMA)'
	@echo '******************************************************************************'

mssTestClean:
	@echo 'Cleaning the mmWave Cascade MSS Unit Test objects (DDMA)'
